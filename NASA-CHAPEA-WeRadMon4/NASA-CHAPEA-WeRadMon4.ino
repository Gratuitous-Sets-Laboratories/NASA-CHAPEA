...
//.............. Identifier Data .............................//
  ...
  const String versionNum = "1.21";                           // version of sketch
  const String lastUpdate = "2023 Feb 21";                    // last update

//.............. Game Tuning .................................//

  int shortButtonTime = 15;                                   // in ms
  int sleepMinutes = 5;                                       // in min
...
//-------------- MAD SCIENCE WEATHER CONTROL! ----------------//
  ...
  if (plcSignal(0) == 7){                                     // if the reset button has been pressed...
  ...
  if (millis() >= lastMinTick + 60000){                       // if a minute has elapsed since the last weather fluctuation...
    somethingNew = true;                                      // something is new (DBTS will report)
    timeTempCycle();                                          // incriment the timeTempCycle
